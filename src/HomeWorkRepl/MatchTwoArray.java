...
//
//hint: you will need a nested for loop to loop all the array. in the if check
// the if the current number is equal to the next (or previous it doesn't matter),
